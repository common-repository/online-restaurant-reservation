 ...
 *
 * This template can be overridden by copying it to yourtheme/restaurant-reservation/emails/customer-cancelled-reservation.php.
 *
...
<p><?php
	if ( $party_size_limit ) {
		printf( __( 'Your reservation on %s has been cancelled because of limited party size. The reservation was as follows:', 'online-restaurant-reservation' ), get_option( 'blogname' ) );
	} else {
		printf( __( 'Your reservation on %s has been cancelled. The reservation was as follows:', 'online-restaurant-reservation' ), get_option( 'blogname' ) );
	}
?></p>
