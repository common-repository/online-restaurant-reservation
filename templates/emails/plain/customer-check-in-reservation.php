<?php
/**
 * Customer check-in reservation email (plain)
 *
 * This template can be overridden by copying it to yourtheme/restaurant-reservation/emails/plain/customer-check-in-reservation.php.
 *
...
echo sprintf( __( "Your recent reservation on %s has been completed. Your reservation details are shown below for your reference:", 'online-restaurant-reservation' ), get_option( 'blogname' ) ) . "\n\n";
