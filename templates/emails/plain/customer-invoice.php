<?php
/**
 * Customer invoice email (plain)
 *
 * This template can be overridden by copying it to yourtheme/restaurant-reservation/emails/plain/customer-invoice.php.
 *
...
if ( $reservation->has_status( 'pending' ) ) {
	echo sprintf( __( 'A reservation has been created for you on %1$s. You will be notified when it is confirmed.', 'online-restaurant-reservation' ), get_bloginfo( 'name', 'display' ) ) . "\n\n";
}
