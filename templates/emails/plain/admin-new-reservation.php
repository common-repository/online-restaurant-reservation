 ...
 *
 * This template can be overridden by copying it to yourtheme/restaurant-reservation/emails/plain/admin-new-reservation.php.
 *
...
echo sprintf( __( 'You have received a reservation from %s.', 'online-restaurant-reservation' ), $reservation->get_formatted_customer_full_name() ) . "\n\n";
