 ...
 * Email Header
 *
 * This template can be overridden by copying it to yourtheme/restaurant-reservation/emails/email-header.php.
 *
				...
				<tr>
					<td align="center" valign="top">
						<div id="template_header_image">
							<?php
								if ( $img = get_option( 'online_restaurant_reservation_email_header_image' ) ) {
