 ...
 *
 * This template can be overridden by copying it to yourtheme/restaurant-reservation/emails/customer-check-in-reservation.php.
 *
...
<p><?php printf( __( 'Your recent reservation on %s has been completed. Your reservation details are shown below for your reference:', 'online-restaurant-reservation' ), get_option( 'blogname' ) ); ?></p>
