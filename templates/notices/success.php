 ...
 *
 * This template can be overridden by copying it to yourtheme/restaurant-reservation/notices/success.php.
 *
...
<?php foreach ( $messages as $message ) : ?>
	<div class="online-restaurant-reservation-message"><?php echo wp_kses_post( $message ); ?></div>
<?php endforeach; ?>
